...
//以下4行从banyan中同名文件夹拷贝
// #define ACTOR_ITFC_CTOR(NAME) NAME(hiactor::actor_base *exec = nullptr)
// #define ACTOR_ITFC_DTOR(NAME) ~NAME() {}
// #define ACTOR_IMPL_CTOR(NAME) NAME(hiactor::actor_base *exec_ctx, const hiactor::byte_t *addr)
